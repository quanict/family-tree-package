...
export const util = (function(){
    ...
    const tree = function(){
        ...
        function getRelationshipBetween(fromId, toId, noOrder, set){
            ...
            function applyCondition(link, id1, id2=null){
    ...
    const getPosition = function(ev:any, container:any=null){
        if (!ev)
            return [NaN, NaN];
        var x = 0, y = 0;
    ...
    const getAncestorByClass = function(element, className, rootAncestor=''){
